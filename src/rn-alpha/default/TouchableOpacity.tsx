...
import { TouchableOpacity as Touch, TouchableOpacityProps, ViewStyle } from 'react-native';
...
export type TouchableCustomProps = {
...
export type Props = TouchableOpacityProps & SpacingProps & LayoutProps & BorderProps & AnimationProps & TouchableCustomProps;

const TouchableOpacity = React.forwardRef<any, Props>((props, ref) => {
